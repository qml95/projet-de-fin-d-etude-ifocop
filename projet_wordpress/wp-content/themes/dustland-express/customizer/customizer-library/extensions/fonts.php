...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'dustland-express' ),
		'cyrillic'     => __( 'Cyrillic', 'dustland-express' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'dustland-express' ),
		'devanagari'   => __( 'Devanagari', 'dustland-express' ),
		'greek'        => __( 'Greek', 'dustland-express' ),
		'greek-ext'    => __( 'Greek Extended', 'dustland-express' ),
		'khmer'        => __( 'Khmer', 'dustland-express' ),
		'latin'        => __( 'Latin', 'dustland-express' ),
		'latin-ext'    => __( 'Latin Extended', 'dustland-express' ),
		'vietnamese'   => __( 'Vietnamese', 'dustland-express' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'dustland-express' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'dustland-express' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'dustland-express' ),
